...
if page == "About Us":
    ...
    and machine learning integration. We aim to empower users to transform raw Airbnb data into actionable 
    knowledge — supporting smarter, faster, and more informed decisions about pricing strategies, market 
    trends, and accommodation choices using intuitive visual tools.
    """)
